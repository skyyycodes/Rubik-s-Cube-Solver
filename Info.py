...
def outputIV(text, blank2):
        ...
        cv.putText(blank2, text, (400, 200), cv.FONT_ITALIC, 1, (0, 0, 255))


# else printing correct seq of answer
def outputAns(text, blank2):
        # Display solution on lower part of panel to avoid overlap
        cv.putText(blank2, 'Solution:', (300, 170), cv.FONT_ITALIC, 0.7, (0, 255, 0))
        cv.putText(blank2, text, (400, 170), cv.FONT_ITALIC, 0.8, (255, 255, 255))
